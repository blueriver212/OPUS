...
class OptimizeADR:
    ...
    def solve_year_zero(self, scenario_name, MOCAT_config, simulation_name, grid_search=False):
        ...
        # sammie addition:
        self.econ_params_gen = EconParameters(self.econ_params_json, mocat=self.MOCAT)
        ...
        return tf, current_environment, species_data, col_probability_all_species, umpy, excess_returns, last_non_compliance, econ_calculator

    def optimize_adr_loop(self, time_idx, simulation_results, species_data, econ_calculator):
        ...
        # # ----- ADR Section ---- # #
        self.adr_params.removals_left = econ_calculator.get_removals_for_current_period()
    ...
    def run_optimizer(self, scenario_name, simulation_name, MOCAT_config):
        simulation_results = {}
        tf, current_environment, species_data, col_probability_all_species, umpy, excess_returns, last_non_compliance, econ_calculator = OptimizeADR.solve_year_zero(self, scenario_name, MOCAT_config, simulation_name, grid_search=False)
        for time_idx in tf:
            simulation_results = OptimizeADR.optimize_adr_loop(self, time_idx, simulation_results, species_data, econ_calculator)